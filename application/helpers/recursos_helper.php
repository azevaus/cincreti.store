...
function grandes_marcas_navbar(){
    $CI = & get_instance();
    $grandes_marcas = $CI->store_model->get_grandes_marcas();
    return $grandes_marcas;

}
function categorias_master_navbar(){
    $CI = & get_instance();
    $master = $CI->store_model->get_categorias_master();
    return $master;
}
function categorias_navbar($categoria_pai_id = NULL){
    $CI = & get_instance();
    $categorias = $CI->store_model->get_categorias($categoria_pai_id);
    return $categorias;
}
