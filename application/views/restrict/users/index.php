                  ...
                  <tbody>
                    <?php foreach ($usuarios as $usuario) : ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url('restrita/usuarios/core/' . $usuario->id); ?>" class="btn btn-dark btn-icon"><i class="far fa-edit"></i></a>
                          <a href="<?php echo base_url('restrita/usuarios/delete/' . $usuario->id); ?>" class="btn btn-danger btn-icon delete" data-confirm="Tem certeza da exclusao?"><i class="fas fa-times"></i></a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
