                    ...
                    <div class="table-content table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="li-product-remove"><a class="btn-del-item" data-id="<?php echo $produto['pro_id']?> "href="#"><i class="fa fa-times"></i></a></td>
                                    <td class="li-product-thumbnail"><a href="<?php echo base_url('produto'.$produto['pro_meta_link'])?>"><img  width="50"src="<?php echo base_url('uploads/products/small/'.$produto['product_photo'])?>" alt="Li's Product Image"></a></td>
                                    <td class="li-product-name"><a href="<?php echo base_url('produto'.$produto['pro_meta_link'])?>"><?php echo word_limiter($produto['pro_name'], 3)?></a></td>
                                    <td class="li-product-price"><span class="amount"><?php echo 'R$&nbsp;'.number_format($produto['pro_value'], 2)?></span></td>
                                    <td class="quantity" style="width: 150px;">
                                        <div class="cart-plus-minus float-left" >
                                            <input id="produto_<?php echo $produto['pro_id']?>" name="produto_quantidade" class="cart-plus-minus-box mask-produto-qty" value="<?php echo $produto['pro_quantity']?>" type="text">
                                            <div class="dec qtybutton"><i class="fa fa-angle-down"></i></div>
                                            <div class="inc qtybutton"><i class="fa fa-angle-up"></i></div>
                                        </div>
                                        <button type="button" data-id="<?php echo $produto['pro_id'] ?>"title="Atualizar quantidade" class="btn-altera-quantidade btn btn-ligth" style="padding: 10px 15px;"><i class="fa fa-refresh"></i></button>
                                    </td>                                    
